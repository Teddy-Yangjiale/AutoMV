      ...
      <section className="workspace">
        ...
        <section className="stage-area">
          ...
          <div className={`canvas-wrap ratio-${ratioClass}`}>
            <div className={`mv-canvas preset-${template}`} style={{ "--dim": dim / 100, "--motion": `${motion / 10}s` } as React.CSSProperties}>
        ...
        <aside className="panel right-panel">
          ...
          <div className="divider" />
          <div className="section-title"><span>字幕摘要</span><button className="text-link">编辑样式 →</button></div>
          <div className="style-summary"><div className="font-preview">Aa</div><span><b>优雅宋体</b><small>居中 · 56 px · 微阴影</small></span></div>
          <div className="divider" />
